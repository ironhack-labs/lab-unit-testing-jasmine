...
describe("Iteration 4", () => {
    ...
    it("should return undefined if the argument passed is not an object", () => { 
        ...
        expect( printFullName(101010) ).toEqual(undefined);
        expect( printFullName("Hello") ).toEqual(undefined);
    });

    it("should return undefined if firstName or lastName fields are missing", () => { 
        expect( printFullName({ firstName: "Deniz" }) ).toEqual(undefined); 
        expect( printFullName({ lastName: "Cilingir" }) ).toEqual(undefined); 
